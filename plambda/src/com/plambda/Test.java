...
public class Test {
	...
	public static void main(String[] args) {
		...
		//Paso3 Conseguir un listado de las casa que tengan un salon de más de 20 m2
		
		//Paso4 Conseguir un listado de Salones con las casas de más de una habitación
		...
		//Paso7 Conseguir el numero total de habitaciones de las casas de mas de 1 habitación,
