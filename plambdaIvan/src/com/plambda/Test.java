...
//		.forEach(y -> System.out.println(y));
		...
		int count= casas.stream()
                 .filter(x -> x.getNumHabitaciones() > 1)
                 .peek(e -> System.out.println("Casas con H m 1: " + e.getNombre()))
               .mapToInt(y -> y.getNumHabitaciones()).sum();      
                 
		 
		 System.out.println("Total de habitaciones de las casas " + count);
